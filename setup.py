...
project_name = "btrfs_prom_exporter"
source_code = "https://github.com/PhilipMay/btrfs-prom-exporter"
keywords = (
    "prometheus",
    "docker",
    "kubernetes",
...
setuptools.setup(
    ...
    keywords=keywords,
    entry_points={"console_scripts": ["btrfs-prom-exporter = btrfs_prom_exporter:cli_main"]},
